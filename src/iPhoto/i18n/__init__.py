...
_ZH: dict[str, str] = {
    ...
    "chat.thinking": "思考中...",
    "action.llm_settings": "LLM 设置",
    "llm_settings.title": "LLM 设置",
    "llm_settings.header": "配置 LLM 模型",
    "llm_settings.description": "配置用于 AI 助手的大语言模型。支持 OpenAI API 兼容的服务。",
    "llm_settings.select_config": "选择配置:",
    "llm_settings.set_active": "设为默认",
    "llm_settings.config_details": "配置详情",
    "llm_settings.name": "名称:",
    "llm_settings.name_placeholder": "配置名称",
    "llm_settings.provider": "提供商:",
    "llm_settings.url": "API URL:",
    "llm_settings.model": "模型:",
    "llm_settings.api_key": "API Key:",
    "llm_settings.api_key_placeholder": "输入 API Key",
    "llm_settings.max_tokens": "最大 Tokens:",
    "llm_settings.temperature": "Temperature:",
    "llm_settings.add": "添加",
    "llm_settings.save": "保存",
...
_EN: dict[str, str] = {
    ...
    "action.llm_settings": "LLM Settings",
    "llm_settings.title": "LLM Settings",
    "llm_settings.header": "Configure LLM Models",
    "llm_settings.description": "Configure the large language model for AI assistant. Supports OpenAI API compatible services.",
    "llm_settings.select_config": "Select Config:",
    "llm_settings.set_active": "Set as Default",
    "llm_settings.config_details": "Configuration Details",
    "llm_settings.name": "Name:",
    "llm_settings.name_placeholder": "Configuration name",
    "llm_settings.provider": "Provider:",
    "llm_settings.url": "API URL:",
    "llm_settings.model": "Model:",
    "llm_settings.api_key": "API Key:",
    "llm_settings.api_key_placeholder": "Enter API Key",
    "llm_settings.max_tokens": "Max Tokens:",
    "llm_settings.temperature": "Temperature:",
    "llm_settings.add": "Add",
    "llm_settings.save": "Save",
